        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2 text-white">
                    ...
                    <ul>
                        <li class="mb-4 flex flex-row gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-sky-50">
                ...
                <div>
                    ...
                    <p>Business Consultant, Auditor, Finance, Coach, Family Business, Accounting, Leadership,
                        Innovative, Success</p>
                </div>
